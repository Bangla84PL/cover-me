...
export default function Home() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setGeneratedLetter(`✅ File Upload Successful!
...
File Details:
- Original Name: ${uploadResult.fileName}
- File Size: ${(cvFile.size / 1024 / 1024).toFixed(2)} MB
- File Type: ${cvFile.type}
- Storage Path: ${uploadResult.filePath}

Next Steps:
The n8n workflow integration will be added later to process your CV and generate cover letters.
